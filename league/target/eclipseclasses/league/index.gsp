		...
		<div id="list-league" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="leagueSize" title="${message(code: 'league.leagueSize.label', default: 'League Size')}" />
				...
				<g:each in="${leagueInstanceList}" status="i" var="leagueInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: leagueInstance, field: "leagueSize")}</td>
